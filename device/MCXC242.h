...
#if !defined(MCXC242_H_)
#define MCXC242_H_                               /**< Symbol preventing repeated inclusion */
...
#include "system_MCXC242.h"            /* Device specific configuration file */
...
typedef struct {
  union {                                          /* offset: 0x0 */
    ...
    __IO uint32_t CRC;                              /**< CRC Data register, offset: 0x0, 'r' suffix has been added to avoid a clash with peripheral base pointer macro 'CRC' */
  };
  union {                                          /* offset: 0x4 */
    struct {                                         /* offset: 0x4 */
...
/*! CRCLL - CRCLL stores the first 8 bits of the 32 bit CRC */
...
/*! CRCLU - CRCLL stores the second 8 bits of the 32 bit CRC */
...
/*! CRCHL - CRCHL stores the third 8 bits of the 32 bit CRC */
...
/*! CRCHU - CRCHU stores the fourth 8 bits of the 32 bit CRC */
...
/*! CRCL - CRCL stores the lower 16 bits of the 16/32 bit CRC */
...
/*! CRCH - CRCH stores the high 16 bits of the 16/32 bit CRC */
...
/*! STOP_ACK_DLY_EN
 *  0b0..Enter and exit KEEP_ALIVE mode until the USB core is idle and there is no USB AHB transfer.
 *  0b1..Enter and exit KEEP_ALIVE mode immediately when there is no USB AHB transfer.
 */
...
/*! AHB_DLY_EN
 *  0b0..Do not delay the USB AHB transfer if the USB AHB transfer occurs while exiting KEEP_ALIVE mode.
 *  0b1..Delay the USB AHB transfer until the clock is recovered, if the USB AHB transfer occurs while exiting KEEP_ALIVE mode.
 */
